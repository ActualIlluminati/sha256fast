...
#[inline(always)]
pub unsafe fn k(x: u32) -> __m128i { _mm_set1_epi32(x as i32) }

#[inline(always)]
pub unsafe fn add(x: __m128i, y: __m128i) -> __m128i { _mm_add_epi32(x, y) }
#[inline(always)]
pub unsafe fn add3(x: __m128i, y: __m128i, z: __m128i) -> __m128i { add(add(x, y), z) }
#[inline(always)]
pub unsafe fn add4(x: __m128i, y: __m128i, z: __m128i, w: __m128i) -> __m128i { add(add(x, y), add(z, w)) }
#[inline(always)]
pub unsafe fn add5(x: __m128i, y: __m128i, z: __m128i, w: __m128i, v: __m128i) -> __m128i {
    add(add3(x, y, z), add(w, v))
}

#[inline(always)]
pub unsafe fn inc(x: &mut __m128i, y: __m128i) -> __m128i {
    *x = add(*x, y);
    *x
}
#[inline(always)]
pub unsafe fn inc3(x: &mut __m128i, y: __m128i, z: __m128i) -> __m128i {
    *x = add3(*x, y, z);
    *x
}
#[inline(always)]
pub unsafe fn inc4(x: &mut __m128i, y: __m128i, z: __m128i, w: __m128i) -> __m128i {
    *x = add4(*x, y, z, w);
    *x
}

#[inline(always)]
pub unsafe fn xor(x: __m128i, y: __m128i) -> __m128i { _mm_xor_si256(x, y) }
#[inline(always)]
pub unsafe fn xor3(x: __m128i, y: __m128i, z: __m128i) -> __m128i { xor(xor(x, y), z) }
#[inline(always)]
pub unsafe fn or(x: __m128i, y: __m128i) -> __m128i { _mm_or_si256(x, y) }
#[inline(always)]
pub unsafe fn and(x: __m128i, y: __m128i) -> __m128i { _mm_and_si256(x, y) }

#[inline(always)]
pub unsafe fn shr(x: __m128i, n: i32) -> __m128i { _mm_srli_epi32(x, n) }
#[inline(always)]
pub unsafe fn shl(x: __m128i, n: i32) -> __m128i { _mm_slli_epi32(x, n) }

#[inline(always)]
pub unsafe fn ch(x: __m128i, y: __m128i, z: __m128i) -> __m128i { xor(z, and(x, xor(y, z))) }
#[inline(always)]
pub unsafe fn maj(x: __m128i, y: __m128i, z: __m128i) -> __m128i { or(and(x, y), and(z, or(x, y))) }
#[inline(always)]
pub unsafe fn big_sigma0(x: __m128i) -> __m128i {
    xor3(or(shr(x, 2), shl(x, 30)), or(shr(x, 13), shl(x, 19)), or(shr(x, 22), shl(x, 10)))
}
#[inline(always)]
pub unsafe fn big_sigma1(x: __m128i) -> __m128i {
    xor3(or(shr(x, 6), shl(x, 26)), or(shr(x, 11), shl(x, 21)), or(shr(x, 25), shl(x, 7)))
}
#[inline(always)]
pub unsafe fn sigma0(x: __m128i) -> __m128i { xor3(or(shr(x, 7), shl(x, 25)), or(shr(x, 18), shl(x, 14)), shr(x, 3)) }
#[inline(always)]
pub unsafe fn sigma1(x: __m128i) -> __m128i { xor3(or(shr(x, 17), shl(x, 15)), or(shr(x, 19), shl(x, 13)), shr(x, 10)) }

#[inline(always)]
pub unsafe fn round(a: __m128i,
                    b: __m128i,
                    c: __m128i,
                    d: &mut __m128i,
                    e: __m128i,
                    ...
                    h: &mut __m128i,
                    k: __m128i) {
    let t1: __m128i = add4(*h, big_sigma1(e), ch(e, f, g), k);
    let t2: __m128i = add(big_sigma0(a), maj(a, b, c));
    *d = add(*d, t1);
    *h = add(t1, t2);
}
...
#[inline(always)]
pub unsafe fn load4(chunk: *const u8) -> __m128i {
    _mm_set_epi32(read_le32(chunk.as_ptr().add(0)) as i32,
                  read_le32(chunk.as_ptr().add(4)) as i32,
                  read_le32(chunk.as_ptr().add(8)) as i32,
                  read_le32(chunk.as_ptr().add(12)) as i32)
}

#[inline(always)]
pub unsafe fn store8(out: *mut u8, mut v: __m128i) {
    write_le32(out.add(0), _mm_extract_epi32(v, 3) as u32);
    write_le32(out.add(32), _mm_extract_epi32(v, 2) as u32);
    write_le32(out.add(64), _mm_extract_epi32(v, 1) as u32);
    write_le32(out.add(96), _mm_extract_epi32(v, 0) as u32);
}

pub unsafe fn digest_init() -> [__m128i; STATE_LEN] {
    [k(H256[0]), k(H256[1]), k(H256[2]), k(H256[3]), k(H256[4]), k(H256[5]), k(H256[6]), k(H256[7])]
}

pub unsafe fn digest_finish(out: &mut [u8; 32], digest: [__m128i; STATE_LEN]) {
...
#[inline(always)]
pub unsafe fn transform_sse(digest: &mut [__m128i; STATE_LEN], input: *const u8 /*&[u8; 64*8]*/) {
    let [mut a, mut b, mut c, mut d, mut e, mut f, mut g, mut h] = *digest;

    let mut w0_3: __m128i;
    let mut w4_7: __m128i;
    let mut w8_13: __m128i;
    let mut w14_15: __m128i;

    w0_3 = load4(input);
    w4_7 = load4(input.add(16));
    w8_13 = read4(input.add(32));
    w14_15 = read4(input.add(48));
