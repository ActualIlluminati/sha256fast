...
static void __sha256_final(sha256_state* sctx, unsigned char* out, int digest_words) {
  ...
  sha256_update(sctx, (const unsigned char *)&bits, sizeof(bits));

  /* Store state in digest */
  for (i = 0; i < digest_words; i++)
    dst[i] = ntohl(sctx->state[i]);
